...
Python 3.8 or later is required on all platforms. Install the two dependencies once:
...
| Format | Date Taken | GPS coordinates | File modified time |
|--------|-----------|-----------------|-------------------|
| JPEG / JPG | ✅ EXIF embedded | ✅ EXIF embedded | ✅ |
| PNG | ✅ tEXt chunk | — | ✅ |
| HEIC / TIFF | ⚠ Logged, needs manual tool | — | ✅ |
| Video (MP4, MOV, etc.) | — complex format | — | ✅ |
...
4. Consider cancelling your Google One subscription if you were paying for extra storage
...
| Package | Purpose |
|---------|---------|
| `paramiko` | SFTP connection to Synology NAS |
| `piexif` | Read and write EXIF metadata in JPEG files |

Install with: `pip install paramiko piexif` (or `pip3` on macOS/Linux if needed).
